...
_FEEDLIST = [
    ...
    {
        "title": "Film-Noir",
        "url": "https://yts.mx/api/v2/list_movies.json?genre=filmnoir&sort_by=rating&limit=50",
    },
    {
        "title": "History",
    ...
    {
        "title": "Sci-Fi",
        "url": "https://yts.mx/api/v2/list_movies.json?genre=scifi&sort_by=rating&limit=50",
    },
    {
        "title": "Sport",
